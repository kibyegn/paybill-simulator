...
ACCOUNT_NUMBERS = ['0123456789', '9876543210', '0123498765']
...
Transaction.create(:mp_transaction_id  => rand(9999), :biller_business_number =>BILLER_BUSINESS_NUMBER.first,
  :transaction_date => Date.today, :transaction_type => "Paybill", :account_number => ACCOUNT_NUMBERS.first,
  :sender_msisdn => "0723456789", :sender_first_name => SENDER_FIRST_NAMES[0], :sender_middle_name =>
  SENDER_MIDDLE_NAMES[0], :sender_last_name => SENDER_LAST_NAMES[0], :amount => "1900", :currency => "KES", :status => "0",
  :description => "Pending")
